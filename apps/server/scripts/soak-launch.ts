...
function main(): void {
  ...
  const anchor: SoakAnchor = {
    ...
    reportSpecVersions: {
      ...
      system_health: 'system.v1',
      positions_snapshot: 'positions.v1',
      shadow_portfolio: 'shadow_portfolio.v1',
      decision_journal: 'decision_journal.v1',
      decision_chain: 'decision_chain.v1',
      reconciliation_actions: 'reconciliation.v1',
      protection_status: 'protection.v1',
      cost_attribution: 'cost.v1',
      strategy_activity: 'strategy.v1',
      observer_diagnostics: 'observer.v1',
      audit_events: 'audit.v1',
      configuration_snapshot: 'configuration.v1',
    },
